...
export const fetchRstaurent=createAsyncThunk('restaurentlist/fetchRestaurent',()=>{
...
const restaurentSlice=createSlice({
    ...
    extraReducers:(builder)=>{
        builder.addCase(fetchRstaurent.pending,(state)=>{
            state.loading=true;
        })
        builder.addCase(fetchRstaurent.fulfilled,(state,action)=>{
            state.allRestaurent=action.payload;
            state.searchRestaurent=action.payload;
            state.loading=false;
            state.Error=""
        })
        builder.addCase(fetchRstaurent.rejected,(state,action)=>{
            state.loading=false;
            state.allRestaurent=[]
